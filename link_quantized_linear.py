...
import function_quantized_linear

class QuantizedLinear(link.Link):


    """Quantized Linear layer (a.k.a. quantized fully-connected layer).
    ...
    def __init__(self, in_size, out_size, wscale=1, bias=0, nobias=False,
        ...
        super(QuantizedLinear, self).__init__(W=(out_size, in_size))
        if initialW is None:
    ...
    def __call__(self, x):
        ...
        """
        return function_quantized_linear.quantized_linear(x, self.W, self.b)
